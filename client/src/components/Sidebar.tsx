    ...
    <>
      ...
      <aside
        ...
        style={{
          ...
          boxShadow: "4px 0 30px var(--color-sidebar-shadow)",
        }}
      >
        {/* Logo area */}
        ...
        <div className="p-4" style={{ borderTop: "1px solid var(--color-accent-cyan-10)" }}>
          ...
          <div className="flex gap-3 justify-center">
            <a
              ...
              style={{ color: "var(--color-text-secondary-50)", fontFamily: "'JetBrains Mono', monospace" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "var(--color-accent-cyan)")}
              onMouseLeave={(e) => (e.currentTarget.style.color = "var(--color-text-secondary-50)")}
            >
          ...
          <div
            ...
            style={{ color: "var(--color-text-secondary-30)", fontSize: "0.6rem", fontFamily: "'JetBrains Mono', monospace" }}
          >
            v2026.03
          </div>
        </div>
